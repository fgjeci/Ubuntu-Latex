...
\author{
\IEEEauthorblockN{Franci Gjeci
}
\IEEEauthorblockA{
\textit{franci.gjeci@gmail.com}}
}
...
Acronyms example \gls{ud}, \gls{prr}, \gls{ma}.
...
\end{itemize}
An excellent style manual for science writers is \cite{github_relay_ns3} 
...
Citation \cite{gjeci2024towards,github_relay_xapp, 10619753, github_relay_config,   10401992}.
